...
namespace RevitSketchPoC.Chat.Services
{
    ...
    public sealed class LlmChatService
    {
        private const string SystemPromptBase =
            ...
            "- create_ceiling_from_room: **PRIMARY for new ceilings when a Room exists** — roomId (or elementId for Room); optional ceilingTypeName, name, boundaryLocation (default finish; same options as floor).\n" +
